...
<body>
  ...
  <section class="cont">
    ...
    <form method="post" class="admin" action="{{route('admin')}}">
        <h2>Admin Login</h2>
        ...
        <a href="{{route('adminsignup')}}">New librarian?Sign up</a><br/>
    </form> 
  </section>
</section>
<section class="cont">
  <section class="content1">
  <form method="post" class="usr" action="{{route('adminreg.store')}}">
  @csrf   
  <h2>User Login</h2>
