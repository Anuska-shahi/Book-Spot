  ...
  <div class="container" >
    <header class="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3 mb-4 border-bottom">
      <a href="/home" class="d-flex align-items-center col-md-3 mb-2 mb-md-0 text-dark text-decoration-none">
        <img src="images/icon.png" width="50" height="40" alt="logo" style="padding-right:0%" >
      ...
      <ul class="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0">
       ...
       <div class="col-md-3 text-end" id ="change">
        ...
        <button type="button" class="btn btn-primary"><a href="/login"><font color="white">Login / Sign up</font></a></button>
      </div>
